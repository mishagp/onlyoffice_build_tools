...
def make():
  ...
  #2021-02-05(MGP) Adding file replace for exports.LICENSE_CONNECTIONS
  ...
  #2021-02-05(MGP) Adding file replace for exports.LICENSE_CONNECTIONS
  base.replaceInFileRE(server_build_dir + "/Common/sources/constants.js", "exports.LICENSE_CONNECTIONS = 20;",
